// C64 Character ROM - both character sets
// Set 1 (uppercase/graphics): indices 0-255
// Set 2 (lowercase/uppercase): indices 256-511
// Each character is 8 bytes (8x8 pixel bitmap)
const C64_CHARROM_SET1 = new Uint8Array([
...
const C64_CHARROM_SET2 = new Uint8Array([
    0x3C, 0x66, 0x6E, 0x6E, 0x60, 0x62, 0x3C, 0x00,
...
// Default to set 1 for backwards compatibility
const C64_CHARROM = C64_CHARROM_SET1;
