...
MODS="startup globals transport connect login frame frame_control frame_gfx navigate directory directory_parse directory_select transfer download mail resources config settings launch launch_helpers menu event_loop partyline modem dosio ui ui_state ui_dialogs dispatch osglue stubs"
