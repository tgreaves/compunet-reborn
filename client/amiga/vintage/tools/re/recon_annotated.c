...

{
  ...
  iVar1 = (**(code **)(AbsExecBase + -0xc6))(param_1 + 0xc);    /* = SysBase.AllocMem() */
  if (iVar1 == 0) {
    iVar1 = 0;
  }
  else {
...
{
  (**(code **)(GfxBase + -0xf0))();    /* = GfxBase.Move() */
  return;
}
...
{
  (**(code **)(GfxBase + -0x156))();    /* = GfxBase.SetAPen() */
  return;
}
...
{
  (**(code **)(DOSBase + -0xc6))();    /* = DOSBase.Delay() */
  return;
}
...
/* ===== thunk_FUN_0010800c @ 0010b880 (size 6) ===== */

undefined1 thunk_FUN_0010800c(void)
...

{
  ...
  while( true ) {
    ...
    *DAT_0012309c = cVar1;
    DAT_0012309c = DAT_0012309c + 1;
    thunk_FUN_001054f8(cVar1,DAT_0011d078);
  }
  return;
}
...
{
  (**(code **)(IntuitionBase + -0x138))();    /* = IntuitionBase.WindowToFront() */
  return;
}
...
/* ===== thunk_FUN_0010800c @ 0010e6e0 (size 6) ===== */
...
/* ===== thunk_FUN_001054f8 @ 0010e716 (size 6) ===== */
...
{
  (**(code **)(IntuitionBase + -0xfc))();    /* = IntuitionBase.ScreenToFront() */
  return;
}
...
{
  (**(code **)(IntuitionBase + -0xa2))();    /* = IntuitionBase.MoveScreen() */
  return;
}
...
{
  (**(code **)(SysBase + -0x1c2))();    /* = SysBase.CloseDevice() */
  return;
}
...
{
  (**(code **)(DOSBase + -0xd2))();    /* = DOSBase.ParentDir() */
  return;
}
...
{
  (**(code **)(SysBase + -0x1bc))();    /* = SysBase.OpenDevice() */
  return;
}
