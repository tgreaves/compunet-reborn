...
**Response is ALWAYS a 6-part directory listing.** The client always parses
the GOTO response as a directory (L_A358 sends 'P' then reads 6-part format).
Sending frame data in response to GOTO will crash the client.
